                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif($p->metode_pembayaran == 'ewallet')
                                        <span class="badge bg-success">E-Wallet</span>
                                    @elseif($p->metode_pembayaran == 'kartuKredit')
                                        <span class="badge bg-secondary">Kartu</span>
                                    @else
                                        <span class="badge bg-light text-muted">-</span>
                                    @endif
                                </td>
                                <td>
                                    <a href="{{ route('Pesan.edit', $p->pesan_id) }}" class="btn btn-info btn-sm py-0 px-2 me-1">Edit</a>
                                    <a href="{{ route('Pesan.destroy', $p->pesan_id) }}" class="btn btn-danger btn-sm py-0 px-2"
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <span class="text-muted" style="font-size:0.78rem;">{{ $p->jenis_kue }} &mdash; {{ $p->ukuran_kue }}</span>
                        </div>
