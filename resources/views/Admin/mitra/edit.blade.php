            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input class="form-control" id="Alamat" type="text" placeholder="Masukan alamat lengkap" name="Alamat"
                        value="{{ old('Alamat', $datamitra->alamat) }}" required>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input class="form-control" id="Email" type="email" placeholder="name@company.com" name="Email"
                        value="{{ old('Email', $datamitra->email) }}" required>
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="Kemitraan" name="Kemitraan" required>
                        ...
                        <option value="Gold" {{ old('Kemitraan', $datamitra->kemitraan) == 'Gold' ? 'selected' : '' }}>Gold
                        </option>
                        <option value="Silver" {{ old('Kemitraan', $datamitra->kemitraan) == 'Silver' ? 'selected' : '' }}>
                            Silver</option>
                    </select>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control datepicker-input" id="Bergabung" name="Bergabung" type="date"
                            value="{{ old('Bergabung', $datamitra->bergabung ? $datamitra->bergabung->format('Y-m-d') : '') }}"
                            required>
                    </div>
                </div>
            </div>
