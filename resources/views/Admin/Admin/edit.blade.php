        ...
        <form action="{{ route('admin.update') }}" method="post">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input class="form-control" id="name" type="text" placeholder="Masukan nama lengkap" name="name"
                        value="{{ $dataadmin->name }}" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="email">Email</label>
                    <input class="form-control" id="email" type="email" placeholder="Masukan email" name="email"
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="role" name="role" required>
                        ...
                        <option value="administrator" {{ $dataadmin->role == 'administrator' ? 'selected' : '' }}>
