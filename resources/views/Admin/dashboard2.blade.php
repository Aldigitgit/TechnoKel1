    ...
    <div class="row mt-5">
            <div class="row ">
                ...
                <div class="col-4 mb-4">
                    <div class="card border-0 shadow">
                        <div class="card-header border-bottom d-flex align-items-center justify-content-between">
                            <h2 class="fs-5 fw-bold mb-0  mx-5">Total User</h2>
                        </div>
                        <div class="card-body">
                            <center>
                                <h3>{{ $totalAdmin }}</h3>
        ...
        <div class="col-3">
            <div class="col-12 px-0 mb-4">
                <div class="card shadow border-0 text-center p-0">
                    <div class="profile-cover rounded-top" data-background="http://placehold.it/226x200"
                        style="background: url(http://placehold.it/226x200);"></div>
                    <div class="card-body pb-5">
                        <img src="http://placehold.it/128x128" class="avatar-xl rounded-circle mx-auto mt-n7 mb-4"
                            alt="Dummy Image">
                        <h4 class="h3">{{ Auth::check() ? Auth::user()->name : '' }}</h4>
                        <h5 class="fw-normal">{{ Auth::check() ? Auth::user()->role : '' }}</h5>
                        <p class="text-gray mb-4">{{ Auth::check() ? Auth::user()->email : '' }}</p>
