    ...
    <form action="{{ route('admin.store') }}" method="post">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input class="form-control" id="name" type="text" placeholder="Masukan nama lengkap" name="name" value="{{ old('name') }}" required>
            </div>
            <div class="col-md-6 mb-3">
                <label for="email">Email</label>
                <input class="form-control" id="email" type="email" placeholder="Masukan email" name="email" value="{{ old('email') }}" required>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 mb-3">
                <label for="password">Password</label>
                <input class="form-control" id="password" type="password" placeholder="Masukan password" name="password" required>
